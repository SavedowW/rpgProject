		...
		if (e.type == SDL_KEYDOWN)
		{
			...
			else if (e.key.keysym.sym == SDLK_z)
			{
				...
				if (state == PLAYERDATA)
				{
					...
					playerDataLines->push_back("HP: " + gameCore->intToString(player->HP) + " / " + gameCore->intToString(player->maxHP));
					playerDataLines->push_back("MP: " + gameCore->intToString(player->MP) + " / " + gameCore->intToString(player->maxMP));
					playerDataLines->push_back("");
					playerDataLines->push_back("Base physical damage: " + gameCore->intToString(player->bpDamage));
					playerDataLines->push_back("Base magical power: " + gameCore->intToString(player->bmPower));
					playerDataLines->push_back("Base physical resist: " + gameCore->intToString(player->bpResist));
					playerDataLines->push_back("Base magical resist: " + gameCore->intToString(player->bmResist));
					playerDataLines->push_back("");
